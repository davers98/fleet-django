...
SECRET_KEY = 'django-insecure-wx8b!ck2q13808jjdz8m@@-hf&x2fp!za3viflwo^mk1ta!s0a'
...
STATICFILES_DIRS = [
    ...
    'humanresource/templates/static/',
    'workshop/templates/static/',
    'staff/templates/static/',
]
